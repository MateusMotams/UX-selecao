...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.register = function (registerUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            var email, password, name, existingUser, hashedPassword, user, _, userWithoutPassword;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        email = registerUserDto.email, password = registerUserDto.password, name = registerUserDto.name;
    ...
    AuthService.prototype.login = function (loginUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            var email, password, user, _a, payload, token;
